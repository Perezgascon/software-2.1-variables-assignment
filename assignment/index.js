...
// let messagePart = "has an average grade of"

// console.log(studentFirstName,studentLastName,messagePart,average)
...
if (average >= passingGrade) {
    console.log(studentFirstName + " " + studentLastName + " got a passing grade.")

} else { console.log(studentFirstName + " " + studentLastName + " failed the test.") }